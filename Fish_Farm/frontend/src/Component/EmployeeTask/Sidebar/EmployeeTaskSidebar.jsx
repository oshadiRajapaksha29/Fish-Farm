...
import './EmployeeTaskSidebar.css';

function EmployeeTaskSidebar({ isSidebarClosed, setSidebarClosed }) {
      ...
      <div className="menu-bar">
        <div className="menu">
          <ul>
            ...
            {/* Dashboard */}
            <li className={`nav-link ${location.pathname === '/dashboard/EmployeeTask' ? 'active' : ''}`}>
              <a href="/dashboard/EmployeeTask" onClick={e => { e.preventDefault(); navigate('/dashboard/EmployeeTask'); }}>
            ...
            {/* Add Tanks */}
            <li className={`nav-link ${location.pathname.startsWith('/dashboard/EmployeeTask/AddTask') ? 'active' : ''}`}>
              <a
                href="/dashboard/EmployeeTask/AddTask"
                onClick={(e) => {
                  e.preventDefault();
                  setActiveMenu(activeMenu === 'TankAddDetails' ? null : 'TankAddDetails');
                  navigate('/dashboard/EmployeeTask/AddTask');
                }}
              >
                <i className="bx bx-plus-circle icon"></i>
                <span className="text nav-text">Add Task</span>
              </a>
            </li>
            ...
            {/* View Details */}
            <li className={`nav-link ${location.pathname === '/dashboard/EmployeeTask/ViewTask' ? 'active' : ''}`}>
              <a href="/dashboard/EmployeeTask/ViewTask" onClick={e => { e.preventDefault(); navigate('/dashboard/EmployeeTask/ViewTask'); }}>
                <i className="bx bx-show icon"></i>
                <span className="text nav-text">View Task</span>
              </a>
            </li>
            ...
            {/* Reports */}
            <li className={`nav-link ${location.pathname === '/dashboard/EmployeeTask/Reports' ? 'active' : ''}`}>
              <a href="/dashboard/EmployeeTask/Reports" onClick={e => { e.preventDefault(); navigate('/dashboard/EmployeeTask/Reports'); }}>
...
export default EmployeeTaskSidebar;
