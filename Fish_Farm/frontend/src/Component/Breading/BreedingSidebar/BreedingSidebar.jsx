...
import './BreedingSidebar.css';

function BreedingSidebar({ isSidebarClosed, setSidebarClosed }) {
      ...
      <div className="menu-bar">
        <div className="menu">
          <ul>
            ...
            {/* Dashboard */}
             <li className={`nav-link ${location.pathname === '/dashboard/Breeding' ? 'active' : ''}`}>
              <a href="/dashboard/Breeding" onClick={e => { e.preventDefault(); navigate('/dashboard/Breeding'); }}>
            ...
            {/* Add Mother */}
            <li className={`nav-link ${location.pathname.startsWith('/dashboard/Breeding/mother') ? 'active' : ''}`}>
              <a
                href="/dashboard/Breeding/mother"
                onClick={(e) => {
                  e.preventDefault();
                  setActiveMenu(activeMenu === 'TankAddDetails' ? null : 'TankAddDetails');
                  navigate('/dashboard/Breeding/mother');
                }}
              >
                <i className="bx bx-plus-circle icon"></i>
                <span className="text nav-text">Add Mother</span>
              </a>
            </li>

              {/* Parent */}
            <li className={`nav-link ${location.pathname === '/dashboard/Breeding/view_parent' ? 'active' : ''}`}>
              <a href="/dashboard/Breeding/view_parent" onClick={e => { e.preventDefault(); navigate('/dashboard/Breeding/view_parent'); }}>
            ...
            {/* Add Baby */}
            <li className={`nav-link ${location.pathname.startsWith('/dashboard/Breeding/baby') ? 'active' : ''}`}>
              <a
                href="/dashboard/Breeding/baby"
                onClick={(e) => {
                  e.preventDefault();
                  setActiveMenu(activeMenu === 'TankAddDetails' ? null : 'TankAddDetails');
                  navigate('/dashboard/Breeding/baby');
                }}
              >
                <i className="bx bx-plus-circle icon"></i>
                <span className="text nav-text">Add Baby</span>
              </a>
            </li>
            ...
            {/* View Details */}
            <li className={`nav-link ${location.pathname === '/dashboard/Breeding/viewmother' ? 'active' : ''}`}>
              <a href="/dashboard/Breeding/viewmother" onClick={e => { e.preventDefault(); navigate('/dashboard/Breeding/viewmother'); }}>
            ...
            {/* Reports*/}
            <li className={`nav-link ${location.pathname === '/dashboard/Breeding/Baby_Mom_Report' ? 'active' : ''}`}>
              <a href="/dashboard/Breeding/Baby_Mom_Report" onClick={e => { e.preventDefault(); navigate('/dashboard/Breeding/Baby_Mom_Report'); }}>
...
export default BreedingSidebar;
